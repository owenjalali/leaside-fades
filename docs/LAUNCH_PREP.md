...
- `NOTIFICATION_DELIVERY_MODE=live` is used only after Twilio/Resend are verified.
...
- Production-like `APP_URL`, live notification mode, Twilio, Resend, and reminder windows
